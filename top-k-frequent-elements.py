...
class Solution:
    ...
    def topKFrequentBucketSort(self) -> List[int]:
        ...
        #example: index 2 is for elements that occurr twice.
        ...
        for n, c in count.items(): #puts each item in the count hashmap, to its corresponding index, considering index == the occurrence of each item. 
            frq[c].append(n)
